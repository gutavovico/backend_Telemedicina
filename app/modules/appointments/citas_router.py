...
citas_router = APIRouter(prefix="/citas", tags=["Citas y Consultas (Appointments)"])
...
@citas_router.get(
    ...
    description="Obtiene la lista de consultas con soporte de búsqueda en tiempo real (paciente, CI, doctor, especialidad) y filtros por fecha o estado."
)
def listar_citas(
