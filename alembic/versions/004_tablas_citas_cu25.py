...
def upgrade() -> None:
    ...
    op.execute("""
        ...
        ALTER TABLE citas ADD COLUMN IF NOT EXISTS id_servicio BIGINT REFERENCES servicios_medicos(id_servicio) ON DELETE SET NULL;
        ...
        ALTER TABLE citas ADD COLUMN IF NOT EXISTS fecha_hora_inicio TIMESTAMP;
        ALTER TABLE citas ADD COLUMN IF NOT EXISTS fecha_hora_fin TIMESTAMP;
        ALTER TABLE citas ADD COLUMN IF NOT EXISTS modalidad VARCHAR(50);
        ALTER TABLE citas ADD COLUMN IF NOT EXISTS motivo TEXT;
        ALTER TABLE citas ADD COLUMN IF NOT EXISTS check_in TIMESTAMP;
        ALTER TABLE citas ADD COLUMN IF NOT EXISTS fecha_creacion TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
